...
<!-- Mirrored from themesground.com/bigshop/V2/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Apr 2019 01:59:49 GMT -->
<head>
<!-- Meta -->
<meta charset="utf-8">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-6 top-search-holder"> 
          ...
          <!-- ============================================================= SEARCH AREA : END ============================================================= --> </div>
        <!-- /.top-search-holder -->
        <div class="col-xs-12 col-sm-10 col-md-3 col-lg-3 header-banner"><img src="<?php echo base_url('assets/images/banners/top-banner-img.jpg'); ?>'); ?>" alt=""></div>
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-1 animate-dropdown top-cart-row"> 
          <!-- ============================================================= SHOPPING CART DROPDOWN ============================================================= -->
        
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              <div class="basket"><img src="<?php echo base_url('assets/images/cart.png'); ?>" alt="">
               <span>My cart</span>
              </div>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                    ...
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="<?php echo base_url('assets/images/banners/top-menu-banner.jpg'); ?>" alt=""> </div>
                          <!-- /.yamm-content --> 
                        </div>
                      </div>
                    </li>
                ...
                <li class="dropdown  navbar-right special-menu"> <a href="#">Reorder your favorites</a> </li>
              </ul>
              <!-- /.navbar-nav -->
              <div class="clearfix"></div>
            </div>
